...
from . import (allocation, benchmarks, breakout, chartable, factor,
               fundamental, longshort, meanrev, ml, regime, riskmanaged,
               tsmom, xsmom)

__all__ = ["Strategy", "allocation", "benchmarks", "breakout", "chartable",
           "factor", "fundamental", "longshort", "meanrev", "ml", "regime",
...
for _mod in (benchmarks, tsmom, xsmom, meanrev, breakout, fundamental, regime,
             riskmanaged, ml, factor, allocation, longshort, chartable):
